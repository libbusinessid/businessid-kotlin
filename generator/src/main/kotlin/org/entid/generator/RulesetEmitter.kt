...
internal class RulesetEmitter(private val bundle: LoadedBundle, private val emitter: Emitter) {
    ...
    fun emit(header: String): String = buildString {
        append(header)
        appendLine("import org.entid.Capability")
        appendLine("import org.entid.ReasonCode")
        appendLine("import org.entid.ValidationProfile")
        appendLine("import org.entid.internal.EvalContext")
        appendLine("import org.entid.runtime.AssertionFailure")
        appendLine("import org.entid.runtime.CanonBuffer")
        appendLine("import org.entid.runtime.ChecksumOutcome")
        appendLine("import org.entid.runtime.CpView")
        appendLine("import org.entid.runtime.Pred")
        appendLine()
