...
open class EngineBenchmark {
    private lateinit var engine: EntIdEngine
...
open class ColdStartBenchmark {
    ...
    fun firstValidation(blackhole: Blackhole) {
        blackhole.consume(
            EntIdEngine.default().validate(IdentifierInput(IdentifierKind.SIRET, "01234567400001")),
        )
    }
}
