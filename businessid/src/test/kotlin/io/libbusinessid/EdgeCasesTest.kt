...
import io.libbusinessid.internal.guardEngineErrors
...
import io.libbusinessid.runtime.cp
import io.libbusinessid.runtime.view
...
class EdgeCasesTest {
    ...
    fun `an engine error carries its message and its cause`() {
        ...
        val failure = assertFailsWith<BusinessIdEngineException> {
