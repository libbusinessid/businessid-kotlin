...
internal class Emitter(private val bundle: LoadedBundle) {
    ...
    private val header = buildString {
        appendLine("// Generated from entid-rules.binpb ${bundle.rulesVersion}. Do not edit by hand:")
        ...
        appendLine("//")
        appendLine("// Copyright The EntID Authors.")
        ...
        appendLine()
        appendLine("package org.entid.generated")
        appendLine()
    }
    ...
    private fun emitConstants(): String = buildString {
        append(header)
        appendLine("import org.entid.runtime.CpView")
        appendLine()
    ...
    private val runtimeImports = listOf(
        "org.entid.ReasonCode",
        "org.entid.ValidationProfile",
        "org.entid.internal.EvalContext",
        "org.entid.runtime.Alignment",
        "org.entid.runtime.Arith",
        "org.entid.runtime.AssertionFailure",
        "org.entid.runtime.CanonBuffer",
        "org.entid.runtime.ChecksumOutcome",
        "org.entid.runtime.Ck",
        "org.entid.runtime.CpView",
        "org.entid.runtime.Pred",
        "org.entid.runtime.Txt",
    )
