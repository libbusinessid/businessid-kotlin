 ...
 */
object Fixtures {
    fun canonicalizationProgram(id: Int): Rules.Program =
        Rules.Program.newBuilder()
            .setId(id)
    ...
    private fun canonicalizationStep(kind: Rules.CanonicalizationOpKind): Rules.Node =
        Rules.Node.newBuilder()
            .setOutputType(Rules.ValueType.VALUE_TYPE_CANONICALIZATION_STEP)
            .setCanonicalizationOperation(Rules.CanonicalizationOperation.newBuilder().setKind(kind))
            .build()

    fun formatProgram(id: Int): Rules.Program =
        Rules.Program.newBuilder()
            .setId(id)
    ...
    private fun require(operand: Int, reason: Rules.ReasonCode, key: String): Rules.Node =
        Rules.Node.newBuilder()
            .setOutputType(Rules.ValueType.VALUE_TYPE_ASSERTION)
    ...
    fun checksumProgram(id: Int): Rules.Program =
        Rules.Program.newBuilder()
            .setId(id)
    ...
    private fun source(): Rules.Source =
    ...
    fun valid(): Rules.RuleBundle.Builder =
