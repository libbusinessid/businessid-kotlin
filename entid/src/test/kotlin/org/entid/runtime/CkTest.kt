...
class CkTest {
    ...
    fun `the three states map onto the steps of the report`() {
        assertEquals(org.entid.StepStatus.VALID, ChecksumStatus.VALID.step)
        assertEquals(org.entid.StepStatus.INVALID, ChecksumStatus.INVALID.step)
        assertEquals(org.entid.StepStatus.UNSUPPORTED, ChecksumStatus.UNSUPPORTED.step)
    }
